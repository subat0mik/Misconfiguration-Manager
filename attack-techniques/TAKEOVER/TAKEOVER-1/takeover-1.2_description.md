...
## Description
Coerce NTLM from SMS Provider and relay to MSSQL on remote site database
...
## Requirements
The site database is not hosted on the SMS Provider

### Coercion
- Valid Active Directory domain credentials
- Connectivity to SMB (TCP/445) on the coercion target, the SMS Provider
